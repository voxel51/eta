...
class ApplyVideoEventDetectorConfig(etam.BaseModuleConfig):
    ...
    def __init__(self, d):
        super(ApplyVideoEventDetectorConfig, self).__init__(d)
...
def run(config_path, pipeline_config_path=None):
    ...
    Args:
        config_path: path to a ApplyVideoEventDetectorConfig file
        pipeline_config_path: optional path to a PipelineConfig file
    '''
    config = ApplyVideoEventDetectorConfig.from_json(config_path)
