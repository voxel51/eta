...
class VisualizeImageLabelsConfig(etam.BaseModuleConfig):
    ...
    def __init__(self, d):
        super(VisualizeImageLabelsConfig, self).__init__(d)
...
def run(config_path, pipeline_config_path=None):
    ...
    Args:
        config_path: path to a VisualizeImageLabelsConfig file
        pipeline_config_path: optional path to a PipelineConfig file
    '''
    config = VisualizeImageLabelsConfig.from_json(config_path)
