...
class ApplyImageModelConfig(etam.BaseModuleConfig):
    ...
    def __init__(self, d):
        super(ApplyImageModelConfig, self).__init__(d)
...
def run(config_path, pipeline_config_path=None):
    ...
    Args:
        config_path: path to a ApplyImageModelConfig file
        pipeline_config_path: optional path to a PipelineConfig file
    '''
    config = ApplyImageModelConfig.from_json(config_path)
