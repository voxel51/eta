...
class TFSlimClassifier(
        etal.ImageClassifier, etal.ExposesClassificationProbabilities,
        etal.FeaturizingClassifier, etat.UsesTFSession):
    ...
    def __init__(self, config):
        ...
        network_fn = nets_factory.get_network_fn(
            network_name, num_classes=len(self._class_labels),
            is_training=False)
    ...
    def generates_features(self):
        '''Whether this classifier generates features for predictions.'''
