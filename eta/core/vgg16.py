...
class VGG16(Configurable, UsesTFSession):
    ...
    def _build_conv_layers(self):
        ...
        with tf.compat.v1.name_scope("conv1_2") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv1_1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[64], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv2_1") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.pool1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
        ...
        with tf.compat.v1.name_scope("conv2_2") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv2_1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[128], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv3_1") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.pool2, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
        ...
        with tf.compat.v1.name_scope("conv3_2") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv3_1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[256], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv3_3") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv3_2, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[256], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv4_1") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.pool3, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
        ...
        with tf.compat.v1.name_scope("conv4_2") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv4_1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[512], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv4_3") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv4_2, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[512], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv5_1") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.pool4, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[512], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv5_2") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv5_1, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[512], dtype=tf.float32),
                trainable=True,
                name="biases",
        ...
        with tf.compat.v1.name_scope("conv5_3") as scope:
            ...
            conv = tf.nn.conv2d(
                input=self.conv5_2, filters=kernel, strides=[1, 1, 1, 1], padding="SAME")
            biases = tf.Variable(
                tf.constant(0.0, shape=[512], dtype=tf.float32),
                trainable=True,
                name="biases",
