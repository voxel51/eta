...
Implements the popular VGG16 network that can be used for classification and embedding of images.
...
class VGG16FeaturizerConfig(Config):
    ''' VGG16 Featurization configuration settings
        ...
        Or, if you have already parsed the config in a different place
        then you can optionally pass the vfconfig object here and it will
        be used rather than a parsed one.
    '''
