...
```python
from eta.core.module import ModuleMetadata

# Load the pipeline
json_path = "eta/modules/simple_object_detector.json"
module_metadata = ModuleMetadata.from_json(json_path)

# Render the block diagram
module_metadata.render("block_diagram.svg")
```
